...
<br/><br/>
Please cite  <Link underline="always" color="text.primary" target="_blank" href="/static/STeLLAR_IISWC21.pdf">
our paper
...
{`author    = {Dmitrii Ustiugov and`}<br/>
 ...
 {`year      = {2021}
              ...
              <Button variant='outlined' target={'_blank'} sx={{my:2}} href='/static/STeLLAR_IISWC21.pdf'>Download Paper</Button>
