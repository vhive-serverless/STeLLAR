      ...
      <Container maxWidth="xl">
        ...
        <Grid container spacing={3}>
            ...
            <Typography variant={'h4'} sx={{ mb: 2 }}>
               Cold Function Invocations - Baseline Latencies
            </Typography>
            ...
            In this experiment, we evaluate the baseline response time of functions with cold instances by issuing invocations with a long inter-arrival time (IAT) of 600 seconds. <br/>
            <br/>
