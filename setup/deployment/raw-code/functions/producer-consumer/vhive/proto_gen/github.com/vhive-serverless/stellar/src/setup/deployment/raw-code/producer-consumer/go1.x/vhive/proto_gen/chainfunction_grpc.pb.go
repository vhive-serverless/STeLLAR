...
const (
	ProducerConsumer_InvokeNext_FullMethodName = "/proto_gen.ProducerConsumer/InvokeNext"
)
...
func (c *producerConsumerClient) InvokeNext(ctx context.Context, in *InvokeChainRequest, opts ...grpc.CallOption) (*InvokeChainReply, error) {
	...
	err := c.cc.Invoke(ctx, ProducerConsumer_InvokeNext_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ProducerConsumer_InvokeNext_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ProducerConsumer_InvokeNext_FullMethodName,
	}
